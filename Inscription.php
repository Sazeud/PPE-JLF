    ...
    <section class="profil" >
        <div class="container bg-secondary py-5">
            ...
            <form action="verificationInscription.php" method="POST">
                ...
                <input type="submit" id='submit' value='Inscription' class="py-1" >
                <p><center><a class="lien" href="Connexion.php">Connexion</a> si vous avez un compte<center></p>
                 <?php
                 //En cas d'erreur renvoi des messages approprié au type d'erreur
                    if(isset($_GET['erreur'])){
                        ...
                        $cree = $_GET['creer'];
                        if($cree == 1){
                            echo "<p>Votre compte a bien été crée ! <a class='lien' href='Connexion.php'>Me connecter</a></p>";
                        }
                    }
                ?>
            </form>
